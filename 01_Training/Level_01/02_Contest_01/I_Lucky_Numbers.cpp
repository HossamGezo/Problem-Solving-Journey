...
int main() {
  ...
  // NOTE --- Another Solution Using ' #include <algorithm> ' library
  ...
  // NOTE --- Another Solution Without using ' #include <algorithm> ' library
  ...
  // NOTE --- Another Solution Without using ' #include <algorithm> ' library "Simpler solution"
